...
public class NoodleMailIncSim extends ConsoleProgram {
        ...
        private MailServer noodleServer;
        private MailServer jabbooServer;
        ...
        public void run() {
                ...
                // to set up initial data for mail servers
                setupInitialState();
        ...
        private void testSendMailToMailServer() {
                ...
                MailMessage msg3 = new MailMessage("user1@jabboo1.com", "user2@noodle.com", "Subject 1", "Hello world!");

                noodleServer.sendMail(msg1);
                noodleServer.sendMail(msg2);
                noodleServer.sendMail(msg3);
